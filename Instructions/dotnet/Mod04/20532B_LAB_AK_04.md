...
Service** **and Storage Account** dialog box.
 ...
 existing Web App, the **Create Web App** **and Storage Account** dialog box displays.

 h. If you have existing cloud
 services, locate the **Web App** list, and then select **Create
New** to open the dialog box.

8. In the **Create Web App
...
>  **Note:** It typically takes five to ten minutes for the publish
 ...
 pane that displays when you publish your Web App project.
