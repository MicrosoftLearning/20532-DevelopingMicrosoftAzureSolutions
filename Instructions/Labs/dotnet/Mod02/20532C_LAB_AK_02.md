...
6. In the **Create virtual machine** blade that displays, click **Basics** and perform the following steps:
  ...
  c. In the **Password** and **Confirm Password** dialog boxes, provide the value **AzurePa$$w0rd**.
...
8. In the **Create Virtual Machine** blade that displays, click **Settings** and perform the following steps:
  ...
  d. Under the **Diagnostic Storage Account** section, select the **Disable** option.

  d. Leave default values for **Public IP Address**, **Network Security Group (firewall)** and **Monitoring**.
...
3. If you have never used **Visual Studio** in the past, you will be prompted to configure settings that will control the appearance of the IDE. You can skip this section and click **OK**.
