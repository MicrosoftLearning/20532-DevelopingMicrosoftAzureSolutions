...
4. In the form that displays, perform the following steps:
    ...
    t. In the **Location** list, select the region that is closest to your location.

    u. Click the **Select** button.

    v. Back in the **SQL Database** blade, click the **Select** button.

    w. Click the **Create** button to create your Web App and SQL database.
