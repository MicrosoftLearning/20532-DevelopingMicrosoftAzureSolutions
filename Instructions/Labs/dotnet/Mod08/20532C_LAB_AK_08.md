...
1. In the **Solution Explorer** pane, expand the **Contoso Events Administration** folder and then expand the **Contoso.Events.Management** project.
...
1. In the **Open Project** dialog box, perform the following steps:
  ...
  a. Go to **Allfiles (F):\\Mod08\\Labfiles\\Starter\\Relay\\Contoso.Events**.
