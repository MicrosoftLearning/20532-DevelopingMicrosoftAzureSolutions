...
3. At the end of the **Seed** method, create an instance of the **Event** class by using the following values:
...
4. At the end of the **Seed** method, add the newly created **Event** to the **context.Events** collection.
